...
def logs_calculator(item_name, daily, empty_divine_charge_value):
    ...
    daily_empty_charges = calculate_empty_charges_per_day(api.flask.app.constants.LOGS_COMPS)
    ...
    per_item_profit = hourly_profit / api.flask.app.constants.ITEMS_DISASSEMBLED_PER_HOUR
...
def soapstone_calculator(daily, empty_divine_charge_value):
    ...
    daily_empty_charges = calculate_empty_charges_per_day(api.flask.app.constants.SOAPSTONE_COMPS)
    ...
    single = hourly / api.flask.app.constants.ITEMS_DISASSEMBLED_PER_HOUR
...
def calculate_daily_soapstone_comps():
    ...
    comps = api.flask.app.constants.SOAPSTONE_COMPS
    ...
    hourly_historic = api.flask.app.constants.ITEMS_DISASSEMBLED_PER_HOUR * p_historic
    daily_historic = hourly_historic * 24
   
    # classic components
    p_not_historic = 1 - p_historic
    p_classic = p_not_historic * comps['special']['classic']
    hourly_classic = api.flask.app.constants.ITEMS_DISASSEMBLED_PER_HOUR * p_classic
...
def calculate_comp_value(crates):
    ...
    small_historic_comp_value = crates['historic']['small'] / api.flask.app.constants.SMALL_CRATE_COMPS
    large_historic_comp_value = crates['historic']['large'] / api.flask.app.constants.LARGE_CRATE_COMPS

    # calculate classic comp values
    small_classic_comp_value = crates['classic']['small'] / api.flask.app.constants.SMALL_CRATE_COMPS
    large_classic_comp_value = crates['classic']['large'] / api.flask.app.constants.LARGE_CRATE_COMPS
...
def calculate_daily_crates(daily_historic, daily_classic):
    ...
    daily_small_historic = daily_historic / api.flask.app.constants.SMALL_CRATE_COMPS
    daily_small_classic = daily_classic / api.flask.app.constants.SMALL_CRATE_COMPS

    # calculate daily large crates
    daily_large_historic = daily_historic / api.flask.app.constants.LARGE_CRATE_COMPS
    daily_large_classic = daily_classic / api.flask.app.constants.LARGE_CRATE_COMPS
...
def crate_values():
    ...
    small_historic = get_item_cost(api.flask.app.constants.SMALL_HISTORIC_CRATE_ID)
    large_historic = get_item_cost(api.flask.app.constants.LARGE_HISTORIC_CRATE_ID)
    small_classic = get_item_cost(api.flask.app.constants.SMALL_CLASSIC_CRATE_ID)
    large_classic = get_item_cost(api.flask.app.constants.LARGE_CLASSIC_CRATE_ID)
...
def cost_of_charge():
    ...
    charge_cost = get_item_cost(api.flask.app.constants.DIVINE_CHARGE_ID) / 3000
...
def calculate_empty_charges_per_day(comps):
    ...
    simple_parts_per_hour = api.flask.app.constants.ITEMS_DISASSEMBLED_PER_HOUR * p_overall
    simple_parts_per_day = simple_parts_per_hour * 24
    empty_divine_charges_per_day = simple_parts_per_day / api.flask.app.constants.SIMPLE_PARTS_PER_EMPTY_DIVINE_CHARGE
