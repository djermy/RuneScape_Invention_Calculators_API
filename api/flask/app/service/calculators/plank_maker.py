...
def plank_calculator(item_idx):
    ...
    logs_name = api.flask.app.constants.PLANK_MAKER_INPUT[item_idx]
    ...
    plank_name = api.flask.app.constants.PLANK_MAKER_OUTPUT[item_idx]
    ...
    cost_of_fuel = api.flask.app.constants.PLANK_MAKER_CHARGES_PER_ITEM * utils.cost_of_charge()
    ...
    hourly = profit_or_loss * api.flask.app.constants.PLANKS_MADE_PER_HOUR
    daily = hourly * 24
